...
/**
 * @ORM\Entity(repositoryClass="App\Repository\Gui\SliceManagerEricssonRepository")
 */
class SliceManagerEricsson
{
	/**
	 * @ORM\Id()
	 * @ORM\GeneratedValue()
	...
	/**
	 * @ORM\OneToMany(targetEntity="App\Entity\Gui\IotConfigurationEricsson", mappedBy="slicemanager")
	 */
