...
/**
 * @ORM\Entity(repositoryClass="App\Repository\Gui\IotConfigurationEricssonRepository")
 */
class IotConfigurationEricsson
{
	/**
	 * @ORM\Id()
	 * @ORM\GeneratedValue()
	...
	/**
	 * @ORM\ManyToOne(targetEntity="App\Entity\Gui\SliceManagerEricsson", inversedBy="iotConfigurations")
	 */
